...
# =============================================================================
# Load the models
rf = pickle.load(open('src/model/my_model.pkl', 'rb'))
new_model = pickle.load(open('src/model/new_model.pkl', 'rb'))
# =============================================================================
# Compress the models
...
pickle.dump(rf_compressed, open('src/model/my_model_rf_compressed.pkl', 'wb'))
pickle.dump(new_model_compressed, open('src/model/new_model_compressed.pkl', 'wb'))
#==============================================================================